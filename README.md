...
1) As administrator, enter the following command in Powershell or download the zip file [here](https://github.com/vizionelkhelp/Metricbeat/archive/7.7.0.zip).

```
Start-BitsTransfer -Source 'https://github.com/vizionelkhelp/Metricbeat/archive/7.7.0.zip' -Destination 'C:\Users\Administrator\Downloads\Metricbeat.zip'
```
